...
start = 1
file = "/root/autodl-tmp/code/code_xwd/dataset/Fashion-MNIST/Spoison-3D/train"
save_file_path = '/root/autodl-tmp/code/code_xwd/dataset/Fashion-MNIST/Spoison-3D/train'
